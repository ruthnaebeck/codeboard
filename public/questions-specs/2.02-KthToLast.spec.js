...
describe('Linked Lists - Kth to Last', function() {
  it('Your function failed. It should throw an error for null or undefined lists.',
    function() {
      chai.expect(() => kthToLast(null)).to.throw(Error)
      chai.expect(() => kthToLast(undefined)).to.throw(Error)
    })
  it('Your function failed. It should throw an error for lists less than or equal to K.',
    function() {
  ...
  [
    ...
    it('Your function failed to get the K to last element in the list.',
      function() {
