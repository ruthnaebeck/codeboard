/* global chai describe it helperLLtoArr helperArrToLL partition */

describe('Linked Lists - Partition', function() {
  [
    {
    ...
    it('Your function failed to partition the list correctly.', function() {
      const list = helperArrToLL(context.list)
      chai.expect(helperLLtoArr(partition(list, context.value))).to.eql(context.expected)
    })
  })
})
